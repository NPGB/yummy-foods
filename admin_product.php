			                ...
			                <div class="col-md-8">
	        		            <?php
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <div class="a-product">
                                                <img class="img" style="max-width:400px;" src="assets/img/<?php echo htmlspecialchars($row['img']) ?>" alt="<?php echo htmlspecialchars($row['img']) ?>">
                                                <form method="POST" action="admin_product.php?id=<?php echo htmlspecialchars($row['product_id']) ?>">
                                                    ...
                                                    <div class="col-12">
                                                        <button type="add" name="delete" class="btn btn-sm btn-primary" style="float: right;">Delete</button>
                                                        <button type="add" name="edit" class="btn btn-sm btn-primary" style="float: right;">Edit</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
