													...
													?>
														...
														?>
															<div class="a-product">
																...
																<img class="img" src="assets/img/user/<?php echo htmlspecialchars($row['image']) ?>" alt="<?php echo htmlspecialchars($row['image']) ?>">
																</a>
																<p class="text-name"><?php echo htmlspecialchars($row['user_name']); ?></p>
															</div>
														<?php 
															endwhile; 
														?>
