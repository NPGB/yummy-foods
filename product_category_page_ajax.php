            ...
            <div class="col-12 col-md-4">
                <table>
                    <tr>
                        ...
                        <td><button class="btn btn-primary"  onclick="var a= document.getElementById('search_text').value; loadDoc('product_page_ajax.php?category=<?php echo $category ?>&search_text='+a, search)">Search</button></td>
                    </tr>
                </table>
            </div>
        </div>
...
<div class="container">
    ...
    //Gọi file connection.php 
        ...
        $name = "where `group_species` like '$category' ";
